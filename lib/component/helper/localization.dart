...
class S implements WidgetsLocalizations {
  ...
  String get strCreateAcc => "Create Account";
  ...
  String get strAppTitle => "iWarranty";

  String get strAlreadyUser => "Already a user";

  String get strEmail => "Email";

  String get strError => "Error";

  String get strName => "Name";

  String get strNewUser => "A new user?";
  ...
  String get strPleaseWait => "Please Wait...";

  String get strSignIn => "Sign In";

  String get strSignUp => "Sign Up";

  String get strSignupSuccess => "Successfully signed up, please Sign In";

  String get strUsername => "Username";

  String get strAdd => "Add";

  String get strEdit => "Edit";
